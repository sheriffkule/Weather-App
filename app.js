...
export const updateWeather = function (lat, lon) {
	...
	fetchData(url.currentWeather(lat, lon), function (currentWeather) {
		...
		card.innerHTML = `
            ...
            <img src="${icon}.png" width="64" height="64" alt="${description}" class="weather-icon">
            </div>
		...
		fetchData(url.forecast(lat, lon), function (forecast) {
			...
			for (const [index, data] of forecastList.entries()) {
               ...
               <div class="card card-sm slider-card">
                  ...
                  <img src="${icon}.png" width="48" height="48" loading="lazy" title="${description}" alt="${description}" class="weather-icon">
            ...
            `;
               ...
               <div class="card card-sm slider-card">
                  ...
                  <img src="direction.png" width="48" height="48" loading="lazy" alt="direction" class="weather-icon" style="transform: rotate(${
						windDirection - 180
					}deg)">
         ...
         `;
			...
			for (let i = 7, len = forecastList.length; i < len; i+=8) {
               ...
               <div class="icon-wrapper">
                     <img src="${icon}.png" alt="${description}" title="${description}" class="weather-icon" width="36px" height="36px">
